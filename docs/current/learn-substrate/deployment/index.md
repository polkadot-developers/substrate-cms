...
developing with [FRAME](learn-substrate/runtime/frame), any storage item that is declared with
...
transformed into actual storage keys for the [storage trie](learn-substrate/runtime/runtime-storage). This
